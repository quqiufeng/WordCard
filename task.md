...
- [x] 8.2 Canvas API（画布级 C ABI + Python 绑定）
- [x] 8.3 `txt2png.py` Python ctypes 绑定
- [x] 8.4 `generate_card.py` 多格式输出（MD/PNG/PDF）
- [x] 8.5 中英双语卡片排版（多字号、多颜色、分栏）

### ✅ 阶段 9: CLI + API (P0)
- [x] 9.1 `engine.py` SM-2 ctypes 绑定
- [x] 9.2 `importer.py` 电子书导入管道
- [x] 9.3 `cli.py` 终端复习（import/review/stats/card）
- [x] 9.4 `api.py` FastAPI REST 接口
